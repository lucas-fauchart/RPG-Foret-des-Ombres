namespace RPG_Forêt_des_Ombres
{
    public partial class FrmExploration : Form
    {
        ...
        internal FrmExploration(List<Heros> lesHeros)
        {
            InitializeComponent();
        ...
        private void FrmExploration_Load(object sender, EventArgs e)
        {
            ...
            lesEnnemis.Add(new Ennemi("ennemi1", "", 30, 30, nombreAleatoireDegatEnnemi1, Image.FromFile("Images/ennemi1.png"), "ombre", 10));
            lesEnnemis.Add(new Ennemi("ennemi2", "", 40, 40, nombreAleatoireDegatEnnemi2, Image.FromFile("Images/ennemi2.png"), "ombre", 11));
            lesEnnemis.Add(new Ennemi("ennemi3", "", 60, 60, nombreAleatoireDegatEnnemi3, Image.FromFile("Images/ennemi3.png"), "ombre", 15));
            lesEnnemis.Add(new Ennemi("ennemi4", "", 80, 80, nombreAleatoireDegatEnnemi4, Image.FromFile("Images/ennemi4.png"), "ombre", 18));
            lesEnnemis.Add(new Ennemi("ennemi5", "", 120, 120, nombreAleatoireDegatEnnemi5, Image.FromFile("Images/ennemi5.png"), "ombre", 23));
            lesEnnemis.Add(new Ennemi("ennemi6", "", 150, 150, nombreAleatoireDegatEnnemi6, Image.FromFile("Images/ennemi6.png"), "ombre", 28));
            lesEnnemis.Add(new Ennemi("ennemi7", "", 200, 200, nombreAleatoireDegatEnnemi7, Image.FromFile("Images/ennemi7.png"), "ombre", 33));
